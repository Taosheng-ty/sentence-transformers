...
def compute_metrics(qids_to_relevant_passageids, qids_to_ranked_candidate_passages):
    ...
    MRR_divideAll = MRR/len(qids_to_relevant_passageids)
    all_scores['MRR @10_divideAll'] = MRR_divideAll
    all_scores['QueriesRanked'] = len(qids_to_ranked_candidate_passages)
    MRR_divideOnlyexist = MRR/len(ranking)
    all_scores['MRR @10_divideonly'] = MRR_divideOnlyexist
    all_scores['QueriesRanked_onlyExist'] = len(ranking)
    return all_scores
